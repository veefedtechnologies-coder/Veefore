    ...
    <div className="space-y-6">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">25.8K</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="border-gray-200">
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle className="text-lg font-semibold text-gray-900">Social performance score</CardTitle>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-baseline space-x-4">
                <span className="text-4xl font-bold text-blue-600">183</span>
              ...
              <div>
                <h4 className="font-medium text-gray-900 mb-1">Doing great!</h4>
                <p className="text-sm text-gray-600">
        ...
        <Card className="border-gray-200">
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle className="text-lg font-semibold text-gray-900">Your social impact at a glance</CardTitle>
              ...
              {socialMetrics.map((metric, index) => (
                <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="font-medium text-gray-900">{metric.platform}</div>
                      <div className="text-sm text-gray-600">{metric.followers} followers</div>
                    </div>
                  </div>
                  <div className={`text-sm font-medium ${
                    metric.engagement.startsWith('+') ? 'text-green-600' : 'text-red-600'
                  }`}>
                    {metric.engagement}
                  </div>
                </div>
