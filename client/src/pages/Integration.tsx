        ...
        <CardHeader className="pb-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <CardTitle className="text-lg font-bold text-gray-900">{config.name}</CardTitle>
          ...
          {isConnected && connectedAccount && (
            <div className="mb-4 p-3 bg-white/60 rounded-lg border border-gray-200">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-semibold text-gray-900">@{connectedAccount.username}</p>
                  <p className="text-sm text-gray-600">{formatFollowersCount(connectedAccount.followers)} followers</p>
                </div>
              </div>
      ...
      <div className="p-8 bg-white min-h-screen">
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-12">
            ...
            <p className="text-lg text-gray-600">Loading your social accounts...</p>
          </div>
        </div>
      </div>
    )
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200">
            <CardContent className="p-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="text-2xl font-bold text-gray-900">{connectedAccounts?.length || 0}</p>
        ...
        <Card className="bg-gradient-to-r from-amber-50 to-orange-50 border-amber-200">
          <CardContent className="p-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Need Help Connecting?</h3>
